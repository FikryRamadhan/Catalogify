...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const newOpacity = Math.max(1 - scrollY );
  ...
  return (
    <nav
      style={{ backgroundColor: `rgba(9, 14, 50` }}
      className="shadow-md min-md:px-20 px-10 mb-5 fixed top-0 left-0 w-full z-50"
    >
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <h1 className="text-xl font-bold text-gray-100">CATALOGIFY</h1>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="text-gray-100 hover:text-gray-100">
              {/* Shopping Cart Icon */}
              <svg
            ...
            <button className="text-gray-100 hover:text-gray-100 hidden md:block">
              {/* User Icon */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
            ...
            <button onClick={toggleMenu} className="lg:hidden text-gray-100 hover:text-gray-100 focus:outline-none">
              {isMenuOpen ? (
                // X Icon
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="fixed top-0 right-0 h-full w-64 bg-gray-100 shadow-lg z-50 lg:hidden transform transition-transform duration-300 ease-in-out">
            <div className="p-5">
              <div className="flex justify-between items-center mb-6">
                <button onClick={toggleMenu} className="text-gray-100 hover:text-gray-100 focus:outline-none">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6"
                    fill="none"
